...
//        SaveColor("Button 1",ColorList[0]);
        SaveColor(QString("Button %1").arg(i+1),ColorList[i]);
    }
}
...
void Widget::on_LoadColor_clicked()
{
    ...
    setLoadedColor("button 2",1,ui->Button_2);
    setLoadedColor("button 3",2,ui->Button_3);
    setLoadedColor("button 4",3,ui->Button_4);
    setLoadedColor("button 5",4,ui->Button_5);
    setLoadedColor("button 6",5,ui->Button_6);
    setLoadedColor("button 7",6,ui->Button_7);
    setLoadedColor("button 8",7,ui->Button_8);
    setLoadedColor("button 9",8,ui->Button_9);
}
